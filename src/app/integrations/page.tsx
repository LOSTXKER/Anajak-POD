...
export default function IntegrationsPage() {
  const [connectedPlatforms, setConnectedPlatforms] = useState(['shopee']);
                    ...
                    <div className="flex justify-between items-start mb-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-500">เชื่อมต่อแล้ว</p>
                        </div>
                      </div>
        ...
        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
           ...
           <div className="p-8 grid lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                 ...
                 <div className="bg-slate-50 p-4 rounded-2xl border border-slate-200">
                    <div className="flex justify-between items-center mb-2">
                       ...
                       <div className="flex items-center gap-1 text-[10px] font-bold text-rose-600 bg-rose-50 px-2 py-0.5 rounded">
              ...
              <div className="bg-indigo-50 rounded-2xl p-6 border border-indigo-100">
                 ...
                 <div className="flex gap-3">
                    <button className="px-4 py-2 bg-white text-indigo-600 font-bold text-sm rounded-xl shadow-sm hover:bg-indigo-50 transition-colors">
                       ดู API Docs
                    </button>
