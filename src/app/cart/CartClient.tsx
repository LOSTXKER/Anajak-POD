          ...
          <div className="lg:w-[400px] flex-shrink-0">
            <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-sm border border-slate-100 sticky top-24">
              ...
              <button
                ...
                className="w-full py-4 bg-ci-blue text-white font-bold rounded-2xl hover:shadow-2xl hover:-translate-y-1 transition-all flex items-center justify-center gap-3 shadow-lg shadow-blue-200 text-lg"
              >
                ดำเนินการต่อ
